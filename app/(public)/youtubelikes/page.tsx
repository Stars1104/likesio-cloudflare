            ...
            <section className="w-full flex flex-col justify-center items-center mt-[100px]">
                <div className="max-w-7xl w-full flex flex-col justify-center items-center pt-10 px-2">
                    <div className="w-full flex flex-col justify-center items-center mb-12">
                        ...
                        <div className="mt-16">
                            <span className="text-center text-lg text-[#001F3F]">At Likes.io, you can buy YouTube likes quickly, safely, and easily with just a few clicks. See our affordable prices and deals below.</span>
                        </div>
                    </div>
                </div>
