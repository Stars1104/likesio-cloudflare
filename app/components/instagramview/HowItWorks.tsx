...
function HowItWorks() {
        ...
        setHowItWork([
            {
                ...
                content: "Choose the number of Instagram views you want. We offer multiple options so you can pick the perfect package for your needs.",
            ...
            },
            {
                ...
                content: "Once your order is confirmed our system kicks in. You'll typically start seeing your view count increase within minutes. We deliver the views quickly and naturally until your order is fulfilled.",
                icon: "/assets/icon/Instant Delivery Begins.svg"
            },
            {
                id: 5,
                title: "Enjoy the Results",
                content: "Sit back and watch your video's view count accelerate. Higher views attract more organic viewers and engagement. And if you have any questions at any point our 24/7 support team is one click away.",
    ...
    return (
        <div className="flex items-center flex-col justify-center mt-24 w-full">
            ...
            <p className="lg:w-[45%] w-full md:text-xl text-base text-start py-4 px-4">
                Getting more Instagram views is as straightforward as it gets. Just follow these simple steps:
            </p>
