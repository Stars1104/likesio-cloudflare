...
const benefitsData = [
  {
    ...
    description: "Boost your post's visibility in Instagram's algorithm. When your posts receive more engagement through Likes, they're more likely to appear in users' feeds and explore pages, helping you reach a wider audience."
  },
  {
    icon: "/assets/icon/Builds Trust and Credibility.svg",
    title: "Build Social Proof",
    description: "Likes create social proof and make your content appear more authentic and engaging. This encourages other users to interact with your posts, creating a snowball effect of organic engagement."
  },
  {
    icon: "/assets/icon/Amplifies Your Social Proof.svg",
    title: "Enhanced Credibility",
    description: "A post with meaningful Likes appears more credible and trustworthy to potential followers. This helps establish your brand's authority and encourages more genuine interactions from your audience."
  }
];
...
function BenefitOfBuyingCom() {
  return (
    <div className="flex items-center flex-col justify-center mt-24 w-full px-2">
      <p className="lg:text-5xl md:text-[2.3rem] text-[1.6rem] font-[system-ui] font-[700] text-center text-[#001F3F]">
        Benefits of Buying{" "}
        <span
          style={{
      ...
      <p className="text-start mt-24 lg:w-1/2 w-full text-gray-600 md:text-lg text-base">
