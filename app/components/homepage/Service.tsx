    ...
    return (
        <div className="max-w-7xl w-full flex flex-col justify-center items-center pt-24">
            <div className="flex flex-col justify-center items-center gap-4 w-full px-2">
                ...
                <span className="md:w-[50%] w-full font-[system-ui] text-lg md:text-center text-start text-[#001F3F]">
                    Instagram promotion made easy. Whether looking for likes, views or <br />
                    followers, you have come to the right place. Let Likes.io do the work. <br /></span>
            </div>
            <div className="md:w-[85%] w-full mt-8 flex flex-col justify-center items-center lg:gap-10 gap-4 md:px-0 px-2">
                <div className="bg-transparent hover:bg-gray-200 border-[#001F3F] transition duration-300 cursor-pointer border border-solid rounded-2xl p-6 md:w-[60%] w-full md:mr-[30%]">
                    ...
                    <div className="flex flex-col items-start gap-2 py-4">
                        ...
                        <p className="text-lg text-[#001F3F] leading-8">
                            Our award-winning, instantly-delivered Instagram likes are sourced from real and active users. Delivered in 30 seconds.
                        </p>
                    </div>
                    <div className="w-full flex justify-start items-center gap-8">
                        ...
                        <span className="text-[#888] font-medium text-lg font-[system-ui]">Starting at $1.99 USD</span>
                    </div>
                </div>
                <div className="bg-transparent hover:bg-gray-200 border-[#001F3F] transition duration-300 cursor-pointer border border-solid rounded-2xl p-6 md:w-[60%] w-full md:ml-[30%]">
                    ...
                    <div className="flex flex-col items-start gap-2 py-4">
                        ...
                        <p className="text-lg text-[#001F3F] leading-8">
                            Our award-winning, instantly-delivered Instagram views are sourced from real and active users. Delivered in 30 seconds.
                        </p>
                    </div>
                    <div className="w-full flex justify-start items-center gap-8">
                        ...
                        <span className="text-[#888] font-medium text-lg font-[system-ui]">Starting at $3.49 USD</span>
                    </div>
                </div>
                <div className="bg-transparent hover:bg-gray-200 border-[#001F3F] transition duration-300 cursor-pointer border border-solid rounded-2xl p-6 md:w-[60%] w-full md:mr-[30%]">
                    <div className="flex items-center gap-4 py-4 border-b">
                    ...
                    <div className="flex flex-col items-start gap-2 py-4">
                        ...
                        <p className="text-lg text-[#001F3F] leading-8">
                            Our award-winning, instantly-delivered Instagram followers are sourced from real and active users. Delivered in 30 seconds.
                        </p>
                    </div>
                    <div className="w-full flex justify-start items-center gap-8">
                        ...
                        <span className="text-[#888] font-medium text-lg font-[system-ui]">Starting at $2.49 USD</span>
                    </div>
                </div>
            </div>
        </div>
