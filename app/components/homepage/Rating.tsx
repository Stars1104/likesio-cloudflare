                ...
                <div className="lg:w-1/2 w-full flex justify-center items-center">
                    <form action="" className="h-fit bg-transparent border border-[#192d5a] rounded-2xl p-4 lg:w-[80%] w-full mx-auto">
                        ...
                        <div className="relative mb-4">
                            <label className="flex items-center mb-2 text-[#192d5a] text-base leading-6 font-[system-ui]">Name </label>
                            <div className="relative text-[#192d5a] focus-within:text-[#192d5a]">
                                ...
                                <input type="text" id="username" className="w-full block h-12 pr-5 pl-12 py-2.5 text-base leading-7 shadow-xs text-[#192d5a] bg-transparent border border-[#192d5a] rounded-lg placeholder-[#192d5a] focus:outline-none" placeholder="Your Name" />
                            </div>
                        </div>
                        <div className="relative mb-4">
                            <label className="flex  items-center mb-2 text-[#192d5a] text-base leading-6 font-[system-ui]">Email </label>
                            <div className="relative text-[#192d5a] focus-within:text-[#192d5a]">
                                <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none ">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="#192d5a" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <input type="text" id="password" className="w-full block h-12 pr-5 pl-12 py-2.5 text-base leading-7 shadow-xs text-[#192d5a] bg-transparent border border-[#192d5a] rounded-lg placeholder-[#192d5a] focus:outline-none" placeholder="Enter Your Email" />
                            </div>
                        </div>
                        <div className="relative mb-4">
                            <label className="flex  items-center mb-2 text-[#192d5a] text-base leading-6 font-[system-ui]">Rating </label>
                            <StarRating />
                        </div>
                        <div className="relative mb-4">
                            <label className="flex  items-center mb-2 text-[#192d5a] text-base leading-6 font-[system-ui]">Message </label>
                            <div className="relative ">
                                <textarea className="block w-full h-40 px-4 py-2.5 text-base leading-7 shadow-xs text-[#192d5a] bg-transparent border border-[#192d5a] rounded-lg placeholder-[#192d5a] focus:outline-none resize-none" placeholder="Write your message"></textarea>
                            </div>
                        </div>
                ...
                <div className="lg:w-1/2 w-full flex flex-col justify-start items-start gap-6">
                    <div className="w-full flex flex-col justify-start items-start gap-4">
                        <div className="w-full flex flex-col justify-start items-start gap-1">
                            ...
                            <span className="flex font-[system-ui] font-normal text-lg text-[#192d5a]">Love this app!</span>
                    ...
                    <div className="w-full flex justify-center items-center">
                        <button onClick={() => ReviewPage()} className="w-full py-3 border border-[#296FF9] uppercase rounded-lg font-[system-ui] bg-transparent text-[#296FF9] from-[#296FF9] to-[#59CEFC] hover:bg-gradient-to-r transition duration-300 hover:text-white">Show All Reviews</button>
                    </div>
                </div>
            </div>
        </div>
