...
const benefitsData = [
  {
    ...
    description: "Boost your post's visibility in Instagram's algorithm. When your posts receive more engagement through comments, they're more likely to appear in users' feeds and explore pages, helping you reach a wider audience."
  },
  {
    icon: "/assets/icon/Builds Trust and Credibility.svg",
    title: "Build Social Proof",
    description: "Comments create social proof and make your content appear more authentic and engaging. This encourages other users to interact with your posts, creating a snowball effect of organic engagement."
  },
  {
    icon: "/assets/icon/Amplifies Your Social Proof.svg",
    title: "Enhanced Credibility",
    description: "A post with meaningful comments appears more credible and trustworthy to potential followers. This helps establish your brand's authority and encourages more genuine interactions from your audience."
  }
];
